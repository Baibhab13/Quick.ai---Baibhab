  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
      ...
      <form action="" className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200' onSubmit={onsubmitHandler}>
        ...
        <textarea value={object} type="text" className='w-full p-2 border border-gray-300 rounded-md' placeholder='e.g., watch or spoon,Only single object name' required onChange={(e) => setobject(e.target.value)} />





        <button className='w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#226BFF] to-[#65ADFF] text-white px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer'><Scissors className='w-5' />Remove Object</button>
